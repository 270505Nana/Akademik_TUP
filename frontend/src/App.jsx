      ...
      <StudentProvider>
        <Routes>
          ...
          <Route
            path="/lengkapi-data"
            element={
              <ProtectedRoute allowedRoles={["STUDENT", "MAHASISWA"]}>
                <LengkapiData />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute allowedRoles={["STUDENT", "MAHASISWA"]} requireCompleteProfile={true}>
                <DashboardMahasiswa />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute allowedRoles={["LECTURER", "DOSEN"]}>
                <DashboardDosen />
              </ProtectedRoute>
            }
          />
